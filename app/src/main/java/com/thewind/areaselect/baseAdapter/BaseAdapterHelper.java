 ...
 */
package com.thewind.areaselect.baseAdapter;
...
//    }
     ...
     * @param viewId
     * @param imageUrl
     * @param defaultImgId 默认图的ID
     * @return
     */
//    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, int defaultImgId) {
//        ImageView view = retrieveView(viewId);
//        if (imageUrl == null || imageUrl.isEmpty()) {
//            Picasso.with(context).load(defaultImgId).into(view);
//        }else {
//            Picasso.with(context).load(imageUrl).into(view);
//        }
//        return this;
